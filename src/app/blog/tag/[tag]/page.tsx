...
export async function generateMetadata(
  ...
  return {
    title: `#${t} Articles | MatchMyInterview Blog`,
    description: `Browse all articles tagged "${t}" on MatchMyInterview — tips and guides to help you succeed.`,
        ...
        <div style={{ background: '#0F172A', padding: 'min(6vw, 64px) min(5vw, 56px)', width: '100%', position: 'relative', overflow: 'hidden' }} className="shrink-0">
          ...
          <div className="relative">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
              <span style={{ fontSize: '11px', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.1em', padding: '4px 12px', borderRadius: '999px', background: 'rgba(59,130,246,0.15)', border: '1px solid rgba(59,130,246,0.25)', color: '#93C5FD' }}>
                Tag
              </span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] xl:grid-cols-[1fr_320px] gap-8 xl:gap-14">
            ...
            <div>
              {posts.length === 0 ? (
                <div style={{ padding: '80px 0', textAlign: 'center' }}>
                  ...
                  <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '8px', color: '#111827' }}>No articles tagged &ldquo;{t}&rdquo;</h2>
            ...
            <div className="hidden lg:block">
              <div className="sticky top-24">
                <BlogSidebar tags={tags} popularPosts={popularPosts} activeTag={t} />
              </div>
            </div>
          </div>
        </div>
